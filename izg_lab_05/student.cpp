...
void	bezierCubicsTrajectory(int quality, const S_Vector *control_points, S_Vector *trajectory_points) {
  ...
  for (int i = 3; i < point2d_vecSize(control_points); i += 3) {
		...
		Point2d * P0 = point2d_vecGetPtr(control_points, i - 3);
		Point2d * P1 = point2d_vecGetPtr(control_points, i - 2);
		Point2d * P2 = point2d_vecGetPtr(control_points, i - 1);
		Point2d * P3 = point2d_vecGetPtr(control_points, i - 0);
